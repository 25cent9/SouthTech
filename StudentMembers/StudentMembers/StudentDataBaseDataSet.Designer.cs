...
namespace StudentMembers {
    ...
    public partial class StudentDataBaseDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentRow AddStudentRow(string student_ID, string student_Phone, string student_LastName) {
...
namespace StudentMembers.StudentDataBaseDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE ((`student_ID` = ?) AND ((? = 1 AND `student_Phone` I" +
                "S NULL) OR (`student_Phone` = ?)) AND ((? = 1 AND `student_LastName` IS NULL) OR" +
                " (`student_LastName` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Student` (`student_ID`, `student_Phone`, `student_LastName`) VALUES " +
                "(?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Student` SET `student_ID` = ?, `student_Phone` = ?, `student_LastName` = " +
                "? WHERE ((`student_ID` = ?) AND ((? = 1 AND `student_Phone` IS NULL) OR (`studen" +
                "t_Phone` = ?)) AND ((? = 1 AND `student_LastName` IS NULL) OR (`student_LastName" +
                "` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentMembers.Properties.Settings.Default.StudentDataBaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        student_ID, student_Phone, student_LastName\r\nFROM            Studen" +
                "t\r\nWHERE        (student_LastName > \'I\') AND (student_Phone > \'9000000\')";
        ...
        public virtual int Delete(string Original_student_ID, string Original_student_Phone, string Original_student_LastName) {
        ...
        public virtual int Insert(string student_ID, string student_Phone, string student_LastName) {
            if ((student_ID == null)) {
            ...
            if ((student_Phone == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(student_Phone));
            }
        ...
        public virtual int Update(string student_ID, string student_Phone, string student_LastName, string Original_student_ID, string Original_student_Phone, string Original_student_LastName) {
            if ((student_ID == null)) {
            ...
            if ((student_Phone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(student_Phone));
            }
            if ((student_LastName == null)) {
            ...
            if ((Original_student_Phone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_student_Phone));
            }
            if ((Original_student_LastName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string student_Phone, string student_LastName, string Original_student_ID, string Original_student_Phone, string Original_student_LastName) {
            return this.Update(Original_student_ID, student_Phone, student_LastName, Original_student_ID, Original_student_Phone, Original_student_LastName);
        }
    }
